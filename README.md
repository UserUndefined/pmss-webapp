PMSS Web Application
=====================================
Angular 1 single page web application for the PMSS system.

### Getting up and running
1. Clone this repo from `https://github.com/userundefined/pmss-webapp.git`
...
This boilerplate uses these core frameworks:
